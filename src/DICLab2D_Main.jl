module DICLab2D
    ...
    function RunProgram()
        ...
        #INPUT ANALYSIS PARAMETERS HERE:
            ...
            InputFolderPath = "Data//Testes de Deslocamento de Corpo Rígido//IMG"
            ...
            GaussWindow = 5
            MinimumZNCC = 0.95
            FilterOutLowQualityPOI = true

            #Area probe parameters

            ROIMaskPath = "Data//Testes de Deslocamento de Corpo Rígido//Mask//00 Teste Corpo Rígido - MASK.jpeg"
            ROIPadding = 0
            GridStep = 25
            ComputeStrains = false
            StrainWindowSize = nothing
